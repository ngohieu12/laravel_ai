...
<head>
    ...
    <style>
        ...
        .prose blockquote { border-left: 4px solid #3b82f6; padding-left: 1em; margin: 1em 0; color: #6b7280; font-style: italic; }
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-8">
                    ...
                    <a href="{{ route('posts.index') }}" class="text-gray-600 hover:text-blue-600 transition {{ request()->routeIs('posts.*') ? 'text-blue-600 font-medium' : '' }}">
                        📝 Bài viết
                    </a>
                    <a href="{{ route('chatbot.index') }}" class="text-gray-600 hover:text-blue-600 transition {{ request()->routeIs('chatbot.*') ? 'text-blue-600 font-medium' : '' }}">
                        🤖 Chatbot
                    </a>
                </div>
                <div class="flex items-center">
                    <a href="{{ route('posts.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition">
                        + Bài viết mới
                    </a>
                </div>
            </div>
