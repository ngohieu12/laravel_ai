    ...
    <div class="bg-white rounded-xl shadow-sm border p-8">
        ...
        <form action="{{ route('dashboard.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-4">
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="content_type" value="text" {{ old('content_type', Post::CONTENT_TYPE_TEXT) === Post::CONTENT_TYPE_TEXT ? 'checked' : '' }} class="w-4 h-4 text-slate-600 border-gray-300 focus:ring-slate-400">
                        <span class="ml-2 text-sm text-gray-700">📝 Bài viết chữ</span>
                    </label>
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="content_type" value="video" {{ old('content_type') === Post::CONTENT_TYPE_VIDEO ? 'checked' : '' }} class="w-4 h-4 text-slate-600 border-gray-300 focus:ring-slate-400">
            ...
            <div>
                ...
                <input type="text" id="category" name="category" value="{{ old('category', 'general') }}" required list="category-list"
                    class="w-full border-gray-300 rounded-lg px-4 py-3 border focus:ring-2 focus:ring-slate-400 focus:border-slate-400"
