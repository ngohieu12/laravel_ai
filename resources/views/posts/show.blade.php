    ...
    <article class="bg-white rounded-xl shadow-sm border overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-slate-50 to-white px-8 py-3 border-b flex flex-wrap items-center gap-2">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u={{ $shareUrl }}" target="_blank" rel="noopener noreferrer"
               class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-[#1877F2] text-white hover:bg-[#166FE5] transition" title="Chia sẻ lên Facebook">
            ...
            <a href="https://twitter.com/intent/tweet?url={{ $shareUrl }}&text={{ $shareTitle }}" target="_blank" rel="noopener noreferrer"
               class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-black text-white hover:bg-gray-800 transition" title="Chia sẻ lên X (Twitter)">
            ...
            <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ $shareUrl }}" target="_blank" rel="noopener noreferrer"
               class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-[#0A66C2] text-white hover:bg-[#004182] transition" title="Chia sẻ lên LinkedIn">
            ...
            <a href="https://t.me/share/url?url={{ $shareUrl }}&text={{ $shareTitle }}" target="_blank" rel="noopener noreferrer"
               class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-[#229ED9] text-white hover:bg-[#1a88bc] transition" title="Chia sẻ lên Telegram">
            ...
            <button type="button" onclick="navigator.clipboard.writeText('{{ route('posts.show', $post) }}').then(()=>{this.textContent='✅ Đã copy';setTimeout(()=>{this.innerHTML='🔗 Copy link'},2000)})"
